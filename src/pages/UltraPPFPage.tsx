...
export const UltraPPFPage: React.FC = () => {
  ...
  const galleryImages = [
    { src: "/01-ultra-ppf-red.webp", alt: "ULTRA PPF - High-Performance Paint Protection" },
    { src: "/02-ultra-ppf-red.webp", alt: "Premium vehicle with ULTRA PPF installed" },
    { src: "/03-ultra-ppf-red.webp", alt: "Self-healing technology demonstration" },
    { src: "/04-ultra-ppf-red.webp", alt: "High-clarity crystal finish" }
  ];
  ...
  return (
    <>
      <div className="ultra-ppf-container" style={{ 
        maxWidth: '1300px', 
        margin: '0 auto', 
        padding: '0 20px',
        width: '100%',
        ...
        <div className="product-layout fade-section" style={{ 
          ...
          <div>
            <p style={{ 
              ...
              <strong>ULTRA PPF</strong> is designed to deliver high-quality protection with exceptional value. Featuring a self-healing top coat, ULTRA PPF ensures that minor scratches disappear over time with heat exposure.
            </p>
            ...
            <p style={{ 
              ...
              The crystal-clear finish maintains your vehicle's original appearance while providing reliable protection against rock chips, road debris, and environmental contaminants. Perfect for daily drivers who want professional-grade protection without the premium price tag.
            </p>
            ...
            <p style={{ 
              ...
              With UV resistance and stain protection, ULTRA PPF prevents yellowing and discoloration, keeping your paint looking newer for longer. Available in multiple thickness options to suit your specific protection needs.
            </p>
          ...
          <div style={{ 
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              <li style={{ 
                ...
                <i className="fas fa-microchip" style={{ color: '#E50914', minWidth: '24px' }}></i> 
              ...
              <li style={{ 
                ...
                High-clarity distortion-free finish
              </li>
              <li style={{ 
                padding: 'clamp(10px, 2vw, 12px) 0', 
                display: 'flex', 
